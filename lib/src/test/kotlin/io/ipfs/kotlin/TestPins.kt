...
class TestPins : BaseIPFSWebserverTest() {
    ...
    "Keys": {
      "<string>": {
        ...
        assertThat(result).isInstanceOf(PinLsListResult.Success::class.java)
        assertThat((result as PinLsListResult.Success).pinLsList).isNotNull()
        assertThat((result).pinLsList.keys?.keys?.size).isEqualTo(1)
